...
class ExabeamTokenManager:
    ...
    Integrates with MCP for token operations.
    """
...
class ExabeamMCPClient:
    """
    MCP client for connecting to Exabeam MCP server.
    Handles token management and MCP protocol communication.
    """
        ...
        try:
            ...
            async with stdio_client(server_params) as (read, write):
                async with ClientSession(read, write) as session:
                    ...
                    self.logger.info("Connected to Exabeam MCP server")
    ...
    async def call_mcp_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Any:
        ...
        try:
            ...
            if "access_token" not in arguments:
